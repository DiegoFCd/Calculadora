...
public class JFrameCalculadora extends javax.swing.JFrame {
    ...
    public JFrameCalculadora() {
        initComponents();
        this.setLocationRelativeTo(null);//Comando para que se ejecute siempre en medio de la pantalla
    }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
         //Convertimos el numero en la casilla(que esta como String) a float
        this.primerNumero = Float.parseFloat(this.casilla.getText());//Convertimos el numero en la casilla a float
        this.operador = "-";
        this.casilla.setText("");
    ...
    //Comando para que podamos escribir todas las veces necesitemos el numero
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
        this.segundoNumero = Float.parseFloat(this.casilla.getText()); //Asignamos el segundo valor ingresado a la var
        
        switch(this.operador){
            case "+":this.casilla.setText(sinCero(this.primerNumero + this.segundoNumero)) ; 
    //Llamaos la funcion que convierte el Float a String y aparte elimina el cero si el residuo de la operacion es igual a 0
            break;
            case "-":this.casilla.setText(sinCero(this.primerNumero - this.segundoNumero));
            break;
            case "*":this.casilla.setText(sinCero(this.primerNumero * this.segundoNumero));
            ...
            case "/":if(this.segundoNumero == 0){
                this.casilla.setText("No se pude dividir entre cero");
            }else{
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        //Conveertimos el numero de la casilla que por defecto esta como String
        this.primerNumero = Float.parseFloat(this.casilla.getText()); //Y lo asignamos a la variable primerNumero
        this.operador = "*";
        this.casilla.setText("");
    ...
    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
        //El numero se puede esccribir una sola vez por cada numero por usamos el if
        if(!(this.casilla.getText().contains("."))){ //Si el numero no posee un punto 
        this.casilla.setText(this.casilla.getText()+".");} //Entonces se lo agregamos
    }//GEN-LAST:event_jButton18ActionPerformed

    
    public String sinCero(float resultado){
        String retorno = "";
        retorno=Float.toString(resultado); //RETORNO ES IGUAL A resultado convertido a String
        
        if(resultado %1 ==0){ //Controlamos si el residuo de la division es 0(el numero dividido en 1 no tiene decimales)
            retorno = retorno.substring(0, retorno.length()-2); //Recortamos el resultado desde el comienzo hasta dos lugares
        }                                                       //antes del final
        return  retorno;
